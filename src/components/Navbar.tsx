          ...
          <div className="flex items-center justify-center gap-0 lg:gap-6 w-full lg:w-auto relative z-50 transition-all duration-500">
            ...
            <div className="hidden lg:flex transition-all duration-700 opacity-100 translate-x-0 scale-100">
              <ExpandableTabs 
                ...
                className="border-white/10 shadow-lg shadow-black/10 bg-white/90 backdrop-blur-xl text-gray-500 flex-nowrap whitespace-nowrap min-w-max h-12 items-center px-2"
              />
            </div>
          </div>

          {/* Tablet Nav (2 Rows, fixed, always visible) */}
          <div className="hidden md:flex lg:hidden justify-center w-full transition-all duration-500 absolute left-1/2 -translate-x-1/2 top-[100%] mt-3">
            <ExpandableTabs 
              tabs={tabs} 
              activeColor="text-white bg-gradient-to-r from-primary to-[#cc7a00] shadow-md" 
              className="border-white/10 shadow-lg shadow-black/10 bg-white/90 backdrop-blur-xl text-gray-500 grid grid-cols-3 w-full max-w-[480px] p-3 gap-2 mx-auto"
            />
          </div>
