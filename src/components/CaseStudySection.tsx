...
const caseStudies: Record<string, CaseStudy> = {
  ...
  beacukai: {
    id: "beacukai",
    title: "SIMIRA & Rotasi Analis System DJBC",
    subtitle: "Sistem Informasi Manajemen Rumah Tangga & Analisis Operasional 5 Bidang Kemenkeu",
    role: "System Analyst & Software Developer Intern",
    date: "Mar 2025 – Jul 2025",
    client: "Kanwil DJBC Sulawesi Bagian Selatan (Kemenkeu RI)",
    heroImage: "/projects/simira-dashboard.jpeg",
    overview: "Merancang dan membangun prototipe aplikasi SIMIRA (Sistem Informasi Manajemen Rumah Tangga) berbasis PHP Laravel & MySQL untuk pencatatan dan monitoring stok gudang secara real-time. Selain itu, mengeksekusi rotasi di 5 bidang strategis Bea Cukai (Kepatuhan Internal, Humas, Kepegawaian, Kepabeanan, dan Penindakan) untuk menganalisis alur kerja operasional instansi.",
    problems: [
      { icon: "inventory_2", title: "Pencatatan Logistik Manual", desc: "Pencatatan stok barang rumah tangga kantor masih berbasis spreadsheet manual, rentan terjadi kebingungan riwayat barang keluar/masuk." },
      { icon: "newspaper", title: "Isu Publik Kepabeanan", desc: "Perlu pemantauan berita harian (Media Monitoring) secara cepat untuk merespon isu kepabeanan dan cukai yang beredar di masyarakat." },
      { icon: "folder_shared", title: "Validasi Data Pegawai", desc: "Kebutuhan perapihan & verifikasi silang (cross-check) data ribuan pegawai instansi di wilayah Sulawesi Bagian Selatan." },
    ],
    metrics: [
      { label: "Rotasi Bidang", value: 5, suffix: " bidang", icon: "published_with_changes" },
      { label: "Modul SIMIRA", value: 4, suffix: " modul", icon: "inventory" },
      { label: "Durasi Magang", value: 4, suffix: " bulan", icon: "event_available" },
      { label: "Monitoring Berita", value: 100, suffix: "%", icon: "newspaper" },
    ],
    techStack: [
      { name: "PHP (Laravel)", category: "Backend" },
      { name: "MySQL", category: "Database" },
      { name: "NALIKA System", category: "Media Analytics" },
      { name: "SIAKAD MBKM", category: "Reporting" },
      { name: "Draw.io", category: "Diagramming" },
    ],
    phases: [
      {
        title: "1. Elicitation & Analisis Proses Bisnis",
        period: "Maret 2025",
        icon: "travel_explore",
        status: "complete",
        roleFocus: "IT Business Analyst (BA)",
        desc: "Wawancara dengan penanggung jawab gudang rumah tangga Kanwil Bea Cukai. Memetakan alur fisik keluar-masuk barang dan mengidentifikasi kebutuhan fitur pencatatan otomatis berbasis peran (Admin & Petugas Gudang).",
        outputs: [
          "Pemetaan Alur Barang Gudang As-Is vs To-Be",
          "Dokumen Spesifikasi Kebutuhan SIMIRA",
          "Daftar Aturan Hak Akses User (Role-Based Access Control)"
        ],
        image: null,
      },
      {
        title: "2. Perancangan Database & Arsitektur SIMIRA",
        period: "Maret 2025",
        icon: "schema",
        status: "complete",
        roleFocus: "System Analyst (SA)",
        desc: "Merancang skema basis data MySQL untuk tabel barang, kategori, log masuk, log keluar, dan user. Membangun prototipe aplikasi berbasis PHP Laravel dengan antarmuka yang bersih dan responsif.",
        outputs: [
          "Skema Relasi Database SIMIRA (MySQL)",
          "Prototipe Aplikasi Web SIMIRA (Laravel)",
          "Fitur Real-time Stock Update & Reporting"
        ],
        image: "/projects/simira-dashboard.jpeg",
      },
      {
        title: "3. Rotasi 5 Bidang Strategis & Media Monitoring",
        period: "April – Juni 2025",
        icon: "badge",
        status: "complete",
        roleFocus: "Operational & Media Analyst",
        desc: "Mengeksekusi NALIKA (Media Monitoring) di Bidang Humas untuk mengklasifikasi berita kepabeanan, cross-check data pegawai di Bidang Umum, serta menganalisis alur pengaduan di Bidang Kepatuhan Internal & Penindakan.",
        outputs: [
          "Laporan Analisis Media Monitoring Harian (NALIKA)",
          "Hasil Cross-check Data Pegawai Kanwil DJBC Sulbagsel",
          "Pemetaan Alur Penanganan Rokok Ilegal & Penindakan"
        ],
        image: "/projects/simira-work-1.jpeg",
      },
      {
        title: "4. Pelaporan Aktivitas & Serah Terima System",
        period: "Juli 2025",
        icon: "verified",
        status: "complete",
        roleFocus: "System Analyst & PM Intern",
        desc: "Menyusun Laporan Akhir Magang Mandiri, melakukan demonstrasi prototipe SIMIRA kepada pembimbing lapangan, dan menyelesaikan validasi logbook resmi di SIAKAD Nobel.",
        outputs: [
          "Laporan Akhir Magang Mandiri Kemenkeu RI (344 Hal)",
          "Validasi Logbook MBKM Resmi SIAKAD Nobel",
          "Serah Terima Prototipe SIMIRA ke Pembimbing"
        ],
        image: "/projects/beacukai-siakad-log.jpeg",
      },
    ],
    fieldPhotos: [
      {
        title: "Dashboard Utama SIMIRA",
        image: "/projects/simira-dashboard.jpeg",
        category: "1. Prototipe Sistem",
        desc: "Tampilan modul dashboard SIMIRA dengan 4 indikator ringkasan stok dan tabel riwayat barang."
      },
      {
        title: "Pengembangan SIMIRA di Meja Kantor",
        image: "/projects/simira-work-1.jpeg",
        category: "2. Dokumentasi Kerja",
        desc: "Aktivitas coding & pengujian sistem SIMIRA di ruang kerja Kanwil Bea Cukai Sulbagsel."
      },
      {
        title: "Suasana Kerja Kanwil Bea Cukai",
        image: "/projects/simira-work-2.jpeg",
        category: "2. Dokumentasi Kerja",
        desc: "Proses verifikasi data dan analisis operasional instansi mengenakan seragam almamater resmi."
      },
      {
        title: "Log Aktivitas MBKM SIAKAD Nobel",
        image: "/projects/beacukai-siakad-log.jpeg",
        category: "3. Validasi Akademik",
        desc: "Rekap logbook harian aktivitas magang yang tervalidasi di portal akademi Nobel Indonesia."
      },
    ]
  },
  bpjs: {
    id: "bpjs",
    title: "Integrasi Data & Otomatisasi BPJS TK",
    subtitle: "Otomatisasi Penagihan WA Blasting, Kualitas Data IGI (>5.000 Data) & Verifikasi OSS",
    role: "Data Analyst & Account Representative Specialist",
    date: "Okt 2024 – Jan 2025",
    client: "BPJS Ketenagakerjaan Kantor Cabang Makassar",
    heroImage: "/experience/bpjs/image14.jpeg",
    overview: "Bertanggung jawab atas validasi dan integritas >5.000 data Kualitas IGI kepesertaan, mengoperasikan otomatisasi penagihan iuran via WA Blasting & Email, memverifikasi data integrasi pelaku usaha dari portal OSS (Online Single Submission), serta mendukung sosialisasi lapangan bagi peserta BPU (Bukan Penerima Upah).",
    problems: [
      { icon: "priority_high", title: "Risiko Discrepancy Data IGI", desc: "Data NIK dan NPP peserta dari berbagai sektor berpotensi tidak sinkron, membutuhkan validasi presisi tinggi." },
      { icon: "mark_email_unread", title: "Tunggakan Iuran Perusahaan", desc: "Proses penagihan iuran manual membutuhkan waktu lama, perlu alur komunikasi massal otomatis." },
      { icon: "domain_disabled", title: "Kepatuhan Pekerja Informal", desc: "Rendahnya kesadaran jaminan sosial pada pekerja informal (BPU) di wilayah Kota Makassar." },
    ],
    metrics: [
      { label: "Data Divalidasi", value: 5000, suffix: "+", icon: "verified_user" },
      { label: "Periode Penagihan", value: 100, suffix: "%", icon: "send" },
      { label: "Durasi Magang", value: 4, suffix: " bulan", icon: "calendar_today" },
      { label: "Integrasi OSS", value: 100, suffix: "%", icon: "sync" },
    ],
    techStack: [
      { name: "OSS System", category: "Government Platform" },
      { name: "WA Blasting Tool", category: "Automation" },
      { name: "Spreadsheet Analytics", category: "Data Validation" },
      { name: "BPJS Internal CRM", category: "Database Management" },
    ],
    phases: [
      {
        title: "1. Pemetaan Alur Data OSS & Kepesertaan",
        period: "Oktober 2024",
        icon: "schema",
        status: "complete",
        roleFocus: "System & Process Analyst",
        desc: "Menganalisis alur masuk data perusahaan baru dari portal Online Single Submission (OSS) Kemeninves/BKPM. Memetakan NIK pengurus dan NPP perusahaan ke dalam database kepesertaan BPJS Ketenagakerjaan.",
        outputs: [
          "Verifikasi Data Pelaku Usaha dari Portal OSS",
          "Pencocokan NIK & NPP Perusahaan Terdaftar",
          "Penerbitan Sertifikat & Spanduk Jasa Konstruksi"
        ],
        image: null,
      },
      {
        title: "2. Validasi & Koreksi Kualitas Data IGI (>5.000 Data)",
        period: "Nov – Des 2024",
        icon: "fact_check",
        status: "complete",
        roleFocus: "Data Quality Analyst",
        desc: "Mengeksekusi pembersihan dan validasi presisi tinggi terhadap >5.000 data Kualitas IGI peserta. Mengoreksi ketidakcocokan identitas pada spreadsheet operasional dan menyinkronkan dengan CRM internal BPJS.",
        outputs: [
          "Pembersihan & Koreksi 5.000+ Data Kepesertaan IGI",
          "Pembaruan Informasi Rekapitulasi Iuran Perusahaan",
          "Pencetakan Kartu & Dokumen Kepesertaan Resmi"
        ],
        image: "/experience/bpjs/image15.jpeg",
      },
      {
        title: "3. Otomatisasi Penagihan Iuran via WA Blasting",
        period: "Desember 2024",
        icon: "campaign",
        status: "complete",
        roleFocus: "Operations & Automation Specialist",
        desc: "Mengkonfigurasi dan mengeksekusi sistem penagihan massal (WA Blasting, SMS, Email) untuk mengingatkan tanggal jatuh tempo iuran serta tunggakan perusahaan penanggung jawab secara terjadwal.",
        outputs: [
          "Sistem Pesan Massal Penagihan Iuran WA Blasting",
          "Laporan Penagihan Tunggakan Perusahaan",
          "Evaluasi Tingkat Kepatuhan Pembayaran Mitra"
        ],
        image: "/experience/bpjs/image24.jpeg",
      },
      {
        title: "4. Akuisisi Lapangan & Sosialisasi Pekerja BPU",
        period: "Januari 2025",
        icon: "diversity_3",
        status: "complete",
        roleFocus: "Public Relations & Field Coordinator",
        desc: "Terjun langsung ke lapangan dalam kegiatan sosialisasi dan pendistribusian brosur kepesertaan Bukan Penerima Upah (BPU) untuk mengedukasi pekerja informal di Kota Makassar.",
        outputs: [
          "Sosialisasi Program Jaminan Sosial Pekerja Informal",
          "Pendistribusian Brosur & Edukasi Kepesertaan BPU",
          "Laporan Akhir Magang Mandiri BPJS Ketenagakerjaan"
        ],
        image: "/experience/bpjs/image27.jpeg",
      },
    ],
    fieldPhotos: [
      {
        title: "Dokumentasi Operasional Kantor BPJS",
        image: "/experience/bpjs/image14.jpeg",
        category: "1. Operasional Kantor",
        desc: "Aktivitas pengelolaan administrasi & verifikasi data di Kantor Cabang BPJS Ketenagakerjaan Makassar."
      },
      {
        title: "Validasi & Cross-check Data IGI",
        image: "/experience/bpjs/image15.jpeg",
        category: "2. Data Quality Control",
        desc: "Proses pencocokan dan koreksi spreadsheet >5.000 data kepesertaan peserta."
      },
      {
        title: "Sistem Komunikasi WA Blasting",
        image: "/experience/bpjs/image24.jpeg",
        category: "3. Penagihan Automasi",
        desc: "Pengoperasian sistem WA Blasting untuk penagihan iuran dan pemberitahuan berkala."
      },
      {
        title: "Sosialisasi Lapangan Kepesertaan BPU",
        image: "/experience/bpjs/image27.jpeg",
        category: "4. Sosialisasi Lapangan",
        desc: "Kegiatan sosialisasi dan edukasi program jaminan sosial pekerja informal di Makassar."
      },
    ]
  },
  topsis: {
