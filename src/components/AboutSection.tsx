...
export default function AboutSection() {
  ...
  return (
    <motion.section className="py-10 md:py-32 bg-bg-main" id="tentang" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} viewport={{ once: true, margin: "-100px" }}>
          ...
          <div className={`lg:col-span-7 flex flex-col items-start gap-6 h-full py-4 justify-center transition-transform duration-500 ${isPhotoHovered ? "lg:translate-x-6" : "translate-x-0"}`}>
            ...
            <div className="flex flex-col gap-1 w-full mt-8 lg:mt-0 items-center lg:items-start text-center lg:text-left">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center lg:justify-start gap-3 mt-3 w-full">
                ...
                <div className="flex flex-row items-center justify-center gap-3 mt-0">
