...
export const fr: Dictionary = {
  ...
  hero: {
    subtitle: "Jeune Diplômé | Analyste d'Affaires IT & PM",
    typewriter: [
      "Analyste d'Affaires IT & Coordinateur de Projet",
      "Solutionneur de Problèmes Orienté Données",
      "SDLC de Bout en Bout",
      "Transformation Numérique"
    ],
    description: "Faire le pont entre les besoins de l'entreprise et des solutions technologiques précises. Expérimenté dans l'orchestration du cycle de vie du développement logiciel (SDLC), l'analyse des processus métiers et la gestion des données pour générer un impact numérique mesurable.",
  },
  about: {
    sectionTitle: "Apprenez à me connaître",
    greeting: "Bonjour ! Je suis diplômé en Systèmes et Technologies de l'Information avec mention Très Bien (GPA 3,93/4,00). J'ai un profond intérêt pour l'intersection des affaires, des données et de la technologie. Pour moi, la technologie n'est pas seulement des lignes de code, mais un outil pour simplifier les processus et résoudre des problèmes concrets.",
    p1: "Bonjour ! Je suis diplômé en Systèmes et Technologies de l'Information avec mention Très Bien (GPA 3,93/4,00). J'ai un profond intérêt pour l'intersection des affaires, des données et de la technologie. Pour moi, la technologie n'est pas seulement des lignes de code, mais un outil pour simplifier les processus et résoudre des problèmes concrets.",
    p2: "Je suis une personne adaptative, très méticuleuse sur les détails et j'aime prendre des initiatives—des traits que je continue de perfectionner à travers diverses expériences de direction d'organisations et de projets numériques. J'apprécie beaucoup le processus consistant à démêler la complexité d'un problème, à le comprendre du point de vue de l'utilisateur, puis à le transformer en une solution élégante et ciblée.",
    viewWork: "Voir le Travail",
    downloadCV: "Télécharger le CV",
    contactMe: "Me Contacter",
  },
  skills: {
    sectionTitle: "EXPÉRIENCE & FOCUS",
    subtitle: "Compétences Principales.",
    description: "Intérêts et expériences dans plusieurs domaines qui se soutiennent mutuellement dans le développement de solutions numériques, de l'analyse à la mise en œuvre.",
    viewDetail: "Voir les Détails",
    focusArea: "Domaine d'Intervention & Technologies",
    items: [
      {
        id: "01",
        title: "Analyse de Systèmes & Processus Métiers",
        desc: "Toute bonne solution commence par une bonne compréhension du problème. J'ai l'habitude d'extraire les besoins des utilisateurs, de structurer les flux de travail, de cartographier les processus métiers et de concevoir l'approche la plus efficace avant le début du développement."
      },
      {
        id: "02",
        title: "Gestion des Données & Validation",
        desc: "Assurer l'intégrité et la qualité des données pour les besoins opérationnels. Expérimenté dans la validation de milliers de données, l'organisation d'ensembles de données complexes et la numérisation de documents pour soutenir la prise de décision."
      },
      {
        id: "03",
        title: "Cycle de Vie du Développement Logiciel (SDLC)",
        desc: "Supervision du cycle de développement logiciel de bout en bout. Veiller à ce que le système ou le site web réponde aux besoins des utilisateurs finaux et atteigne les objectifs visés."
      },
      {
        id: "04",
        title: "Coordination de Projet & Leadership",
        desc: "Agir comme un pont entre les besoins de l'entreprise (non techniques) et l'équipe de développement (technique). Habitué à diriger des équipes et à maintenir la communication entre les parties prenantes."
      },
      {
        id: "05",
        title: "Communication Visuelle & Prototypage",
        desc: "Traduire les idées en conceptions visuelles faciles à comprendre. Du wireframing, prototypage d'interface de base, à la création de supports de communication numérique."
      },
      {
        id: "06",
        title: "Développement Assisté par l'IA",
        desc: "Utilisation de la technologie d'Intelligence Artificielle (Prompt Engineering) pour accélérer le processus de recherche et explorer des solutions pour améliorer la productivité."
      }
    ]
  },
  experience: {
